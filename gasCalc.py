...
cursor = conn.cursor()
# txt文件存储位置
self_FilePath = r"E:\Python_env\gas_txt"

# 数据库获取

# SQL 查询语句
sql_comp = "SELECT * FROM compoilconfig_gas"
sql_weight = "SELECT weight FROM dispatchweight_gas"
sql_prod = "SELECT * FROM prodoilconfig_gas"
# try:
# 执行SQL语句
