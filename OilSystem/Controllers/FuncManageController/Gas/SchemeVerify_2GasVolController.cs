...
[ApiController]
[Route("[controller]")]
public class SchemeVerify_2GasVolController : ControllerBase
{

    private readonly oilblendContext context;

    public SchemeVerify_2GasVolController(oilblendContext _context)
    {
       context = _context;
    }
    ...
    public ApiModel Set1()//model里的名字 多个数据用IEnumberable，单个数据不用
    {
        ...
        for(int i = 0; i < ProdOilPercentList.Count; i++){
            ...
            result.gas92Percent = ProdOilPercentList[i].gas92FlowPercentVol;
            result.gas95Percent = ProdOilPercentList[i].gas95FlowPercentVol;
            result.gas98Percent = ProdOilPercentList[i].gas98FlowPercentVol;
            result.gasSelfPercent = ProdOilPercentList[i].gasSelfFlowPercentVol;
    ...
    {   
        ...
        ProdOilPercentList[obj.index].gas92FlowPercentVol = obj.gas92Percent;
        ProdOilPercentList[obj.index].gas95FlowPercentVol = obj.gas95Percent;
        ProdOilPercentList[obj.index].gas98FlowPercentVol = obj.gas98Percent;
        ProdOilPercentList[obj.index].gasSelfFlowPercentVol = obj.gasSelfPercent;
        ...
        for(int i = 0; i < ProdOilPercentList.Count; i++){
            sum1 += ProdOilPercentList[i].gas92FlowPercentVol;
            sum2 += ProdOilPercentList[i].gas95FlowPercentVol;
            sum3 += ProdOilPercentList[i].gas98FlowPercentVol;
            sum4 += ProdOilPercentList[i].gasSelfFlowPercentVol;
        }
